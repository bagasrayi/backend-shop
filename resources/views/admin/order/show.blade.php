...
<td>:</td>
 <td>
 {{ $invoice->courier }} / {{
$invoice->service }} / {{ moneyFormat($invoice->cost_courier) }}
 </td>
 </tr>
<tr>
 <td>
...
.20rem">:</td>
 <td style="padding:
.20rem"><b>{{ $product->qty }}</b></td>
 </tr>
 </table>
 </td>
<td class="b-none text-right">
 <p class="m-0 font-weightbold">{{ moneyFormat($product->price) }}</p>
 </td>
 </tr>
 @endforeach
 </tbody>
