...
<div class="container-fluid mb-5">
 ...
 <h6 class="m-0 font-weight-bold"><i class="fa fashopping-bag"></i> PRODUK</h6>
 </div>
 <div class="card-body">
...
method="GET">
 ...
 <a href="{{
route('admin.product.create') }}" class="btn btn-primary btn-sm"
...
center">
 {{ ++$no +
($products->currentPage()-1) * $products->perPage() }}</th>
 <td>{{ $product->title }}</td>
